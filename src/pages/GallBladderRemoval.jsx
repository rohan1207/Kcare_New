      ...
      <div className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <aside className="lg:col-span-1 space-y-8 lg:sticky lg:top-24 h-fit">
            ...
            >
              <h3 className="text-2xl font-bold text-sky-900 mb-6 text-center">Find Relief from Gallstones</h3>
              <p className="text-center text-gray-600 mb-6">Contact us to schedule a consultation for gallbladder surgery.</p>
              <Link 
                to="/contact"
