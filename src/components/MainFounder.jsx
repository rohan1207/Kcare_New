...
const MainFounder = () => {
  ...
  return (
    <section className="relative bg-gradient-to-b from-white via-amber-50/20 to-white py-12 sm:py-16 lg:py-20 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_30%,_var(--tw-gradient-stops))] from-amber-100/20 via-transparent to-transparent" />
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <motion.div
          ...
          className="bg-white/80 backdrop-blur-sm rounded-3xl overflow-hidden grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-0 items-center shadow-2xl shadow-amber-900/10 ring-1 ring-amber-100/50"
        >
          {/* Text Content - 3 columns */}
          <div className="lg:col-span-3 p-8 sm:p-10 lg:p-12">
            <motion.div variants={itemVariants}>
              <span className="inline-block text-sm font-semibold text-amber-600 tracking-wide uppercase bg-amber-50 px-3 py-1 rounded-full">
                Meet Our Founder
              </span>
            ...
            >
              {STATS.map((stat, index) => (
                <div
                  key={index}
                  className="flex items-center gap-2.5 bg-gradient-to-br from-amber-50/80 to-yellow-50/50 px-4 py-2.5 rounded-xl border border-amber-100/60 group hover:border-amber-200 transition-all"
                >
            ...
            >
              <a
                href="/founders/pramod-kadam"
                className="group inline-flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-amber-400 to-orange-500 hover:from-yellow-400 hover:to-amber-500 text-white text-sm font-semibold rounded-full shadow-lg shadow-amber-500/30 transition-all duration-300"
              >
                Learn More
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-2.5 border-2 border-amber-200 text-amber-700 hover:bg-amber-50 text-sm font-semibold rounded-full transition-all duration-300"
              >
                Book Consultation
              </a>
            </motion.div>
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-t lg:bg-gradient-to-l from-amber-100/20 via-transparent to-transparent z-10" />
            <img
              src="/pramod3.png"
              alt="Dr. Pramod Kadam"
