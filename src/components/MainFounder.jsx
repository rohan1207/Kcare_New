          ...
          <div className="lg:col-span-3 p-8 sm:p-10 lg:p-12">
            ...
            >
              {STATS.map((stat, index) => (
                <div
                  key={index}
                  className="flex items-center gap-2.5 bg-gradient-to-br from-emerald-50/80 to-sky-50/50 px-4 py-2.5 rounded-xl border border-emerald-100/60 group hover:border-emerald-200 transition-all"
                >
